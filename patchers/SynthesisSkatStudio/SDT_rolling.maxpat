...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 515.0, 514.0, 186.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 252.5, 186.0, 23.0 ],
					"text" : "Impact object parameters"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 494.0, 185.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 203.0, 185.0, 23.0 ],
					"text" : "Modal object parameters"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 464.0, 305.0, 150.0, 34.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 59.5, 46.25, 125.0, 34.0 ],
					"text" : "Start rolling with default parameters"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 465.25, 417.0, 91.0, 20.0 ],
					"text" : "prepend shape"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 465.25, 377.5, 70.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 109.375, 160.0, 70.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 465.25, 251.0, 70.0, 124.0 ],
					"setminmax" : [ 0.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 469.0, 226.0, 62.5, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 48.0, 160.0, 62.5, 23.0 ],
					"text" : "shape",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 444.0, 226.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 271.0, 183.5, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 583.0, 200.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 610.5, 200.0, 61.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 49.0, 131.0, 61.0, 23.0 ],
					"text" : "grain",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 684.5, 196.0, 150.0, 241.0 ],
					"text" : "A checker\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 610.5, 417.0, 85.0, 20.0 ],
					"text" : "prepend grain"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 610.5, 374.5, 70.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 109.375, 131.0, 70.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 610.5, 223.0, 70.0, 124.0 ],
					"setminmax" : [ 0.0, 100.0 ],
					"slidercolor" : [ 0.0, 0.8, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 670.5, 817.5, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 632.0, 817.5, 25.0, 25.0 ]
				}
...
,
					"patching_rect" : [ 422.0, 639.5, 92.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 353.0, 377.5, 70.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 109.375, 102.0, 70.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 353.0, 219.0, 70.0, 124.0 ],
					"setminmax" : [ 0.0, 100.0 ],
					"slidercolor" : [ 0.0, 0.8, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 696.0, 692.5, 25.5, 89.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 59.5, 308.5, 25.5, 104.5 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 645.5, 692.5, 50.0, 89.5 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.375, 308.5, 38.0, 104.5 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "bang" ],
									"patching_rect" : [ 50.0, 116.0, 57.0, 17.0 ],
									"text" : "t i b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 88.0, 139.0, 40.0, 17.0 ],
									"text" : "del 400"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 100.0, 32.5, 15.0 ],
									"text" : "80"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 88.0, 163.5, 53.0, 15.0 ],
									"text" : "80, 0 2000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 180.5, 46.0, 17.0 ],
									"text" : "line"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 50.0, 257.5, 25.0, 25.0 ]
								}
...
,
					"patching_rect" : [ 305.0, 187.5, 30.0, 17.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 9.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 645.5, 86.5, 103.0, 80.0 ],
					...
					"presentation" : 1,
					"presentation_rect" : [ 182.5, 0.0, 75.0, 56.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 540.5, 270.0, 98.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 305.0, 432.0, 32.0, 17.0 ],
					"text" : "pink~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 200.0, 377.5, 127.0, 20.0 ],
					"text_width" : 65.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 353.0, 350.0, 86.5, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 367.75, 196.0, 122.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 102.0, 99.0, 23.0 ],
					"text" : "velocity m/s",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 353.0, 432.0, 76.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 305.0, 463.5, 253.0, 43.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 410.0, 155.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					"attr" : "dissipation",
					"attrfilter" : [ "dissipation", "stiffness" ],
					"fontname" : "Helvetica Neue",
					"fontsize" : 12.0,
					"id" : "obj-34",
					"maxclass" : "attrui",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 319.0, 514.0, 196.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 275.5, 196.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 305.0, 540.5, 255.0, 80.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 305.0, 604.0, 56.0, 17.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 422.0, 665.5, 47.0, 17.0 ],
					"text" : "*~ 55000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 514.0, 239.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 226.0, 239.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 437.0, 264.0, 43.0 ],
					"text" : "sdt.inertial hammerr @mass 0.00428"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 296.0, 116.25, 51.75, 51.75 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 37.375, 51.75, 51.75 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1718.25, 402.0, 121.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1718.25, 432.0, 86.0, 20.0 ],
					"text" : "s #1outnames"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1586.25, 402.0, 117.0, 18.0 ],
					"text" : "velocity shape grain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1586.25, 432.0, 79.0, 20.0 ],
					"text" : "s #1innames"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1846.0, 402.0, 40.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 160.0, 350.75, 40.0, 20.0 ],
...
,
					"patching_rect" : [ 1846.0, 432.0, 40.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1461.0, 399.0, 47.0, 18.0 ],
					"text" : "Rolling"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1461.0, 432.0, 63.0, 20.0 ],
					"text" : "s #1name"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1363.5, 399.0, 32.5, 18.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1260.0, 399.0, 32.5, 18.0 ],
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1260.0, 323.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1363.5, 432.0, 73.0, 20.0 ],
					"text" : "s #1outputs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1260.0, 432.0, 65.0, 20.0 ],
					"text" : "s #1inputs"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 107.0, 390.0, 146.0, 23.0 ],
					"text" : "#1",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 95.0, 248.0, 97.0 ],
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 197.0, 248.0, 106.0 ],
					"rounded" : 0
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 362.5, 459.5, 314.5, 459.5 ],
					"source" : [ "obj-56", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 550.5, 632.0, 431.5, 632.0 ],
					"source" : [ "obj-63", 2 ]
				}
