...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					"automation" : "ResonatorControls",
					"automationon" : "ResonatorControls",
					"id" : "obj-105",
					"maxclass" : "live.text",
					"mode" : 0,
					"numinlets" : 1,
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 659.0, 496.0, 121.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 130.0, 9.0, 121.0, 24.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "live.text[1]",
							"parameter_enum" : [ "ResonatorControls", "ResonatorControls" ],
							"parameter_mmax" : 1.0,
							"parameter_type" : 2,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 659.0, 534.0, 37.0, 18.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 659.0, 560.0, 53.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 166.0, 118.0, 24.0, 20.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 218.0, 713.0, 66.0, 20.0 ],
					"text" : "clip~ -1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 278.75, 713.0, 66.0, 20.0 ],
					"text" : "clip~ -1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 103.0, 685.5, 46.0, 20.0 ],
					"text" : "*~ 200"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 511.0, 660.0, 46.0, 20.0 ],
					"text" : "*~ 200"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 243.0, 656.5, 162.0, 49.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 36.0, 335.5, 162.0, 49.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "bell",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 291.0, 744.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 243.0, 744.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 404.0, 546.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 375.0, 546.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 230.0, 78.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 488.0, 480.0, 50.0, 17.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 627.0, 182.0, 150.0, 17.0 ],
					"text" : "parametri intensità"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 387.0, 175.0, 150.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 2.0, 2.0 ],
					"patching_rect" : [ 688.0, 16.0, 225.0, 111.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 692.0, 125.0, 108.0, 23.0 ],
					"text" : "breaking",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 726.0, 633.0, 165.0, 87.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 491.0, 496.0, 59.0, 17.0 ],
					"text" : "value out"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 404.0, 496.0, 69.0, 17.0 ],
					"text" : "maxtime out"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 649.0, 199.0, 86.0, 38.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 134.0, 291.0, 86.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 599.0, 199.0, 57.0, 38.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 79.0, 291.0, 60.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 556.0, 199.0, 32.0, 27.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 45.0, 291.0, 32.0, 27.0 ],
					"text" : "initial strike"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 393.25, 205.0, 56.0, 27.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 134.0, 154.0, 88.0, 17.0 ],
					"text" : "deceleration factor"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 337.0, 186.0, 37.0, 38.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 88.0, 154.0, 46.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 242.0, 552.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 230.0, 276.0, 23.0, 15.0 ],
					"text" : "114"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 375.0, 118.0, 46.0, 17.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 706.0, 228.0, 18.0, 144.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 179.0, 193.0, 18.0, 76.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 705.0, 375.0, 35.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 178.0, 272.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 726.0, 326.0, 34.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 494.0, 228.0, 18.0, 144.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 134.0, 193.0, 18.0, 76.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 650.0, 375.0, 35.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 134.0, 272.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 670.0, 325.0, 35.0, 38.0 ],
					"text" : "scale 0 127 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 618.0, 228.0, 18.0, 144.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 91.0, 193.0, 18.0, 76.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 617.0, 375.0, 35.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 90.0, 272.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 637.0, 326.0, 36.0, 38.0 ],
					"text" : "scale 0 127 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 563.0, 228.0, 18.0, 144.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 193.0, 18.0, 76.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 562.0, 375.0, 35.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 45.0, 272.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 582.0, 313.0, 41.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 460.0, 228.0, 18.0, 144.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 180.5, 56.0, 18.0, 76.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 459.0, 375.0, 35.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 180.5, 135.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 301.0, 34.0, 58.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 230.0, 299.0, 18.0, 144.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 44.0, 56.0, 18.0, 76.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 229.0, 446.0, 56.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 36.0, 135.0, 43.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 250.0, 397.0, 61.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 405.0, 228.0, 18.0, 144.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 134.0, 56.0, 18.0, 76.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 347.0, 228.0, 18.0, 144.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 88.0, 56.0, 18.0, 76.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 404.0, 375.0, 35.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 134.0, 135.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 425.0, 326.0, 35.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 367.0, 300.0, 34.0, 58.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 334.0, 408.0, 35.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 88.0, 135.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 86.0, 633.0, 444.0, 17.0 ],
					"text" : "impact_inertialb_modalb~ 10000000. 1. 10000. 0.001 2 2 d d 1. 1. 1. 632. 7603. 0.0008 0.04 0 1. 1. 1 0.5 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 130.0, 546.0, 50.0, 15.0 ],
					"text" : "10000."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 59.0, 119.0, 68.0, 17.0 ],
					"text" : "_keystroke f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 197.0, 446.0, 29.0, 15.0 ],
					"text" : "0.3"
				}
...
,
					"patching_rect" : [ 262.0, 593.0, 85.0, 17.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 86.0, 6.0, 15.0, 15.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 245.0, 21.0, 89.0, 17.0 ],
									"text" : "unpack 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 245.5, 6.0, 15.0, 15.0 ]
								}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 386.0, 73.0, 44.0, 27.0 ],
													"text" : "/ 100000."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 385.5, 44.0, 30.0, 27.0 ],
													"text" : "dbtoa"
												}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 283.0, 27.0, 69.0, 17.0 ],
									"text" : "freq_mode1"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 597.0, 26.0, 59.0, 17.0 ],
									"text" : "gain_mode1"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 525.0, 26.0, 69.0, 17.0 ],
									"text" : "gain_mode0"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 444.0, 27.0, 79.0, 17.0 ],
									"text" : "decay_mode1"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 368.0, 27.0, 77.0, 17.0 ],
									"text" : "decay_mode0"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 218.0, 27.0, 69.0, 17.0 ],
									"text" : "freq_mode0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 570.0, 157.5, 54.0, 17.0 ],
									"text" : "@ pickup 0",
									"textcolor" : [ 0.105882, 0.215686, 0.803922, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 586.0, 141.0, 32.5, 15.0 ],
									"text" : "0.87"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 611.0, 45.0, 14.0, 114.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 611.0, 161.0, 33.0, 17.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 540.0, 45.0, 14.0, 114.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 447.0, 140.0, 32.5, 15.0 ],
									"text" : "0.011"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 283.0, 141.0, 32.5, 15.0 ],
									"text" : "0.69"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 214.0, 142.0, 32.5, 15.0 ],
									"text" : "0.76"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 457.0, 161.0, 40.0, 17.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 470.5, 140.0, 14.0, 114.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 458.5, 44.0, 14.0, 114.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 388.0, 162.0, 40.0, 17.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 388.0, 45.0, 14.0, 114.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 540.0, 161.0, 33.0, 17.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 303.0, 162.0, 40.0, 17.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 303.0, 45.0, 14.0, 114.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 234.0, 163.0, 40.0, 17.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 234.0, 46.0, 14.0, 114.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 117.0, 29.0, 54.0, 17.0 ],
									"text" : "gain_fact"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 131.0, 47.0, 16.0, 51.0 ],
									"size" : 256.0
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 130.0, 102.0, 36.0, 17.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 56.0, 29.0, 68.0, 17.0 ],
									"text" : "decay_fact"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 74.0, 47.0, 16.0, 51.0 ],
									"size" : 256.0
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 73.0, 102.0, 38.0, 17.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 20.0, 47.0, 16.0, 51.0 ],
									"size" : 256.0
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 183.0, 6.0, 80.0, 17.0 ],
									"text" : "(modal object)"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 21.0, 2.0, 228.0, 26.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 0.0, 0.0, 658.0, 26.0 ],
									"rounded" : 0,
									"varname" : "String[4]"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 19.0, 102.0, 37.0, 17.0 ],
									"triscale" : 0.9
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 1.0, 29.0, 49.0, 17.0 ],
									"text" : "freq_fact"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 1.0, 24.0, 658.0, 166.0 ],
									"rounded" : 0,
									"varname" : "String[7]"
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 1,
									"midpoints" : [ 22.5, 43.0, 223.5, 43.0 ],
									"source" : [ "obj-63", 0 ]
								}
...
,
					"patching_rect" : [ 376.0, 593.0, 75.0, 17.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 9.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 242.0, 528.0, 87.0, 17.0 ],
					"text" : "_randy -1. 1. 5."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 197.0, 118.0, 69.0, 17.0 ],
					"text" : "_keystroke d"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 130.0, 572.0, 70.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 334.0, 446.0, 250.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 275.0, 118.0, 69.0, 17.0 ],
					"text" : "_keystroke s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "bang" ],
					"patching_rect" : [ 130.0, 145.0, 69.0, 17.0 ],
					"text" : "_keystroke a"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 142.0, 219.0, 49.0, 17.0 ],
					"text" : "delay 15"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 218.0, 502.0, 34.0, 17.0 ],
					"text" : "t f b"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 414.0, 480.0, 35.0, 17.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 346.0, 377.0, 34.0, 15.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 212.0, 476.0, 27.0, 17.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 192.0, 283.0, 100.0, 17.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 36.0, 154.0, 51.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 471.0, 616.0, 26.0, 17.0 ],
					"text" : "gain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 499.0, 788.0, 88.0, 18.0 ],
					"text" : "audioR audioL"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 499.0, 818.0, 86.0, 20.0 ],
					"text" : "s #1outnames"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 367.0, 788.0, 125.0, 18.0 ],
					"text" : "velocity decay freqlist"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 367.0, 818.0, 79.0, 20.0 ],
					"text" : "s #1innames"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 625.75, 788.0, 40.0, 20.0 ],
					"presentation" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 177.0, 241.0, 227.0, 75.0 ],
									"presentation" : 1,
									"presentation_linecount" : 5,
									"presentation_rect" : [ 9.0, 64.0, 227.0, 75.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 177.0, 221.0, 102.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 9.0, 44.0, 102.0, 20.0 ],
									"text" : "INSTRUCTIONS:"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 26.0, 88.0, 150.0, 20.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 9.0, 10.0, 150.0, 20.0 ],
									"text" : "spray shaking sound"
								}
...
,
					"patching_rect" : [ 625.75, 820.0, 40.0, 20.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 241.75, 785.0, 32.5, 18.0 ],
					"text" : "Bell"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 241.75, 818.0, 63.0, 20.0 ],
					"text" : "s #1name"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 497.0, 16.0, 150.0, 34.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.25, 785.0, 32.5, 18.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 40.75, 785.0, 32.5, 18.0 ],
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 40.75, 755.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 144.25, 818.0, 73.0, 20.0 ],
					"text" : "s #1outputs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.75, 818.0, 65.0, 20.0 ],
					"text" : "s #1inputs"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 11.0, 9.0, 108.0, 27.0 ],
					"text" : "Bell"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 497.0, 7.0, 166.0, 56.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 251.5, 575.0, 441.5, 575.0 ],
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 384.5, 197.0, 239.5, 197.0 ],
					"source" : [ "obj-42", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 68.5, 534.0, 139.5, 534.0 ],
					"source" : [ "obj-75", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 497.5, 472.0, 221.5, 472.0 ],
					"source" : [ "obj-84", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 284.5, 260.0, 343.5, 260.0 ],
					"source" : [ "obj-85", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 139.5, 213.0, 151.5, 213.0 ],
					"source" : [ "obj-86", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 151.5, 260.0, 343.5, 260.0 ],
					"source" : [ "obj-87", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 355.5, 399.0, 343.5, 399.0 ],
					"source" : [ "obj-90", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-105" : [ "live.text[1]", "live.text[1]", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "_keystroke.maxpat",
				"bootpath" : "/Users/damien.jacquet/Documents/Max/SDT_Max6/SDT_externals/SDT_common_abstractions",
				"patcherrelativepath" : "../../../SDT_Max6/SDT_externals/SDT_common_abstractions",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
...
, 			{
				"name" : "impact_inertialb_modalb~.mxe",
				"type" : "iLaF"
			}
 ]
	}
