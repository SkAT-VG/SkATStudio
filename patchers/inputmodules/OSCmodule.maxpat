...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 840.0, 659.0, 155.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 848.5, 693.0, 137.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 840.0, 622.0, 134.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 840.0, 575.0, 215.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 69.0, 389.0, 150.0, 20.0 ],
					"text" : "Out: OSC data"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-7",
					"maxclass" : "bpatcher",
					"name" : "OSCreceive.maxpat",
					"numinlets" : 0,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 72.0, 152.0, 304.0, 198.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 1.0, 304.0, 198.0 ],
					"varname" : "OSCreceive"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 500.25, 656.0, 37.0, 18.0 ],
					"text" : "OSC"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 500.25, 686.0, 93.0, 20.0 ],
					"text" : "s #1outnames"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 368.25, 686.0, 86.0, 20.0 ],
					"text" : "s #1innames"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 243.0, 653.0, 37.0, 18.0 ],
					"text" : "OSC"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 243.0, 686.0, 72.0, 20.0 ],
					"text" : "s #1name"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 42.0, 591.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 145.5, 686.0, 82.0, 20.0 ],
					"text" : "s #1outputs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 42.0, 686.0, 76.0, 20.0 ],
					"text" : "s #1inputs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 325.75, 43.0, 101.0, 18.0 ],
					"text" : "set #1"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-7::obj-15" : [ "live.text[1]", "live.text", 0 ],
			"obj-6" : [ "live.text[50]", "live.text", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "OSCreceive.maxpat",
