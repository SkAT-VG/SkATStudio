...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 582.5, 367.5, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 645.5, 337.5, 65.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 79.375, 246.0, 65.0, 20.0 ],
					"text" : "amp "
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 582.5, 337.5, 50.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 16.375, 246.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 582.5, 313.5, 41.0, 20.0 ],
					"text" : "dbtoa"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 447.75, 653.0, 63.0, 18.0 ],
					"text" : "pitch amp"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 56.0, 118.0, 150.0, 48.0 ],
									"presentation" : 1,
									"presentation_rect" : [ 9.0, 60.0, 285.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 9.0, 79.0, 285.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 9.0, 40.0, 285.0, 20.0 ],
									"text" : "Input 1 : signal"
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 9.0, 10.0, 285.0, 20.0 ],
									"text" : "Pitch detection (based on fiddle~ from M. Pucket"
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 413.5, 258.5, 74.689453, 18.0 ],
					"presentation_rect" : [ 413.5, 258.5, 74.689453, 18.0 ],
					"text" : [ "_(midi2hz $1)" ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.5, 337.5, 53.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.5, 414.5, 53.0, 20.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 23.5, 337.5, 232.0, 97.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 79.0, 143.5, 76.0, 20.0 ],
					"text" : "unpack 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 23.5, 112.5, 241.0, 20.0 ],
